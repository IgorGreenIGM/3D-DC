...
with open("matrix_2D.txt", mode="w") as _2D, open("matrix_3D.txt", mode="w") as _3D, open("matrix_2D_3D.txt", mode="w") as _2D_3D:
    for matrix_size in range(1, 1000):
        print(f"process status : {matrix_size} / 1000")

        print("\n\nProcessing 2D : ---------------------------------------------------------------------------------------\n")
        os.system(f"output.exe img.png {matrix_size} {queue_size} 1 0")
        ...
        print("\n\nProcessing 3D : ---------------------------------------------------------------------------------------\n")
        os.system(f"output.exe img.png {matrix_size} {queue_size} 0 1")
        ...
        print("\n\nProcessing 2D_3D : ---------------------------------------------------------------------------------------\n")
        os.system(f"output.exe img.png {matrix_size} {queue_size} 1 1")
